        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <ol>
                <li>
                  <b>Step-by-Step document</b> - <a href="https://portal.itsupport.com.bd/" target="_blank">Documentation</a>
                </li>
                <li>
                ...
                <li>
                  <b>IT Support BD Portal Details:</b>
                  <ul>
                    <li><b>Application License Key</b> (obtainable from <a href="https://portal.itsupport.com.bd/" target="_blank">Portal</a>)</li>
                    <li>
                      <b>Client ID (User ID)</b>
                    </li>
                  </ul>
                </li>
              </ol>
