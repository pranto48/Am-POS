              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="AmPOS" required>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_purchase_code">Application License Key: <span class="text-danger">*</span></label>
                        <input type="text" name="LICENSE_KEY" required class="form-control" id="envato_purchase_code" placeholder="AMP256-XXXXXXXX-XXXXXXXX-XXXXXXXX-XXXXXXXX">
                        <p class="help-block">Get your license from <a href="https://portal.itsupport.com.bd" target="_blank">portal.itsupport.com.bd</a></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_username">Client ID (Your Email / Username):</label>
                        <input type="text" name="CLIENT_ID" class="form-control" id="envato_username" placeholder="e.g. mail@example.com (optional)">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="help-block">For support &amp; notifications</p>
                    </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="db_username" name="DB_USERNAME" required placeholder="e.g. root">
                    </div>
                  </div>

                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="db_password">Database Password: <small class="text-muted">(leave blank if no password)</small></label>
                        <input type="password" class="form-control" id="db_password" name="DB_PASSWORD" placeholder="Leave blank if no password">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="noreply@yourdomain.com (optional)">
                        <p class="help-block">Used as the sender for system emails. Can be configured later in Business Settings.</p>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="AmPOS (Optional)">
                    </div>
                  </div>
