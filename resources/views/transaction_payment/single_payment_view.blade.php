          ...
          <div class="col-xs-6">
            ...
            @elseif($single_payment_line->method == "cheque")
              ...
              @if(!empty($single_payment_line->cheque_due_date))
                <strong>@lang('lang_v1.due_date') :</strong>
              ...
              @if(!empty($single_payment_line->cheque_status))
                ...
                @lang('cheque::lang.status_' . $single_payment_line->cheque_status)
                <br>
              @endif
              @if($single_payment_line->cheque_status === 'bounced' && !empty($single_payment_line->bounce_reason))
                <br>
                <strong>@lang('lang_v1.bounce_reason') :</strong>
                {{ $single_payment_line->bounce_reason }}
                <br>
              @endif
