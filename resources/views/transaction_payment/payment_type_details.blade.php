...
<div class="payment_details_div @if( $payment_line->method !== 'cheque' ) {{ 'hide' }} @endif" data-type="cheque" >
	...
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("cheque_due_date", __('lang_v1.due_date')) !!}
			<div class="input-group">
				<span class="input-group-addon">
					<i class="fas fa-calendar-alt"></i>
				</span>
				{!! Form::text("cheque_due_date", !empty($payment_line->cheque_due_date) ? @format_date($payment_line->cheque_due_date) : null, ['class' => 'form-control date_picker', 'placeholder' => __('lang_v1.due_date'), 'readonly']); !!}
			</div>
		</div>
	</div>
</div>
